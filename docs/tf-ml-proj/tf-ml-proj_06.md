...
+   ![](img/9b5a1e8a-8850-47f6-af12-bdfefc76b742.png)表示随机选中一个人患糖尿病的概率，这里是 1%。![](img/3ed237e2-b687-4dce-9b02-5cfc221d8105.png)也被称为贝叶斯术语中的**先验**，它表示我们在没有任何额外信息时对一个事件的信念。
