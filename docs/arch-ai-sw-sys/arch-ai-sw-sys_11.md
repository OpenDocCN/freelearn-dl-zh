...
![](img/pdf-file.png) 免版税 PDF/ePub 下载
...
扫描此二维码或访问[`packtpub.com/unlock`](https://packtpub.com/unlock)。| ![](img/Unlock2.png) |

| 在打开的页面（如果您在桌面端，将类似于图 X.1），通过书名搜索这本书。请确保您选择了正确的版本。![网页截图 AI 生成的内容可能不正确。](img/Packt_unlock_landing_page.png)图 X.1：桌面端 Packt 解锁着陆页面 |
| --- |
...
如果您遇到困难需要帮助，请访问[`www.packtpub.com/unlock-benefits/help`](https://www.packtpub.com/unlock-benefits/help)获取有关如何查找发票及其他信息的详细 FAQ。以下二维码将直接带您到帮助页面：| ![](img/Need_help.jpg) |
...
![](https://www.amazon.com/Domain-Driven-Refactoring-hands-transforming-microservices/dp/1835889107)
