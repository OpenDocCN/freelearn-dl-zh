...
1.  启动PuTTY。你将看到一个类似于*图4.3*的屏幕。在`raspberrypi.local`上点击**打开**以登录到你的树莓派：

    ![](img/B15660_04_03.jpg)
...
1.  在`raspi-config`中，选择**网络选项**，如图4.6所示。使用键盘上的箭头键突出显示并按*Enter*键选择条目：

    ![](img/B15660_04_06.jpg)

    图4.6 – 网络选项

1.  现在选择**主机名**，如图4.7所示：

    ![](img/B15660_04_07.jpg)
...
1.  在`raspi-config`的顶部菜单中选择**更改用户密码**（*图4.8*）：

    ![](img/B15660_04_08.jpg)
...
1.  使用*Tab*键跳转到**完成**项（*图4.9*）并按*Enter*键：

    ![](img/B15660_04_09.jpg)

    图4.9 – 选择完成

1.  下一屏会询问你是否想要重启Pi。选择**是**并按*Enter*键（*图4.10*）：

    ![](img/B15660_04_10.jpg)
...
1.  使用PuTTY再次连接到你的机器人，使用你为机器人提供的新的主机名（在我的例子中，是`myrobot`），以`.local`结尾，并使用新密码，如图*图4.12*所示：

    ![](img/B15660_04_12.jpg)
